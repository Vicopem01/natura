...
import { ELIGIBILITY_QUESTIONS_2 } from "@/constants";
...
const Stage3 = () => {
  ...
  const handleSubmit = async () => {
    await axios.post(`/api/eligible?stage=3&id=${id}`, state);
    router.push("/eligibility?stage=success");
  };

  return (
    <div className="px-16 max-w-2xl mx-auto">
      <ol className="list-decimal">
        {ELIGIBILITY_QUESTIONS_2.map((data, idx) => (
